...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="../myapp/html/home.jsp">
				<img src="assets/images/logo.png" width=230px height=40px
					alt="Progressus HTML5 template" ></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li><a href="../myapp/html/home.jsp">홈</a></li>
					<c:if test="${sessionScope.mvo != null}">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">개인성향분석<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="../myapp/html/disc.jsp">DISC란?</a></li>
							<li><a href="../myapp/html/personal.jsp">검사하기</a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="../myapp/html/faq.jsp">FAQ</a></li>
							<!-- <li><a href="../myapp/html/table.jsp">질문게시판</a></li> -->
						</ul></li>
					<c:choose>
					<c:when test="${sessionScope.mvo != null}">
						<li><a href="../myapp/html/mypage.jsp">마이페이지</a></li>
						<li class="active"><a class="btn" href="../myapp/logout.do"
							id="sign_in_btn">로그아웃</a></li>
					</c:when>
					<c:otherwise>
							<li class="active"><a class="btn" href="../myapp/html/login.jsp"

...
<div align="center">
    ...
    <thead>
		<tr>
		<th scope="col" style="width:100px;">Company</th>
		<th scope="col" style="text-align:middle; width:100px;">Industry</th>
		</tr>
	</thead>
    <tbody>
    <tr>
   	 	<c:forEach var="clvo" items="${requestScope.clvo}">
			<tr>
			<td style="width:100px;"><a href="showCompany.do?comName=${clvo.comName}">${clvo.comName}</a></td>

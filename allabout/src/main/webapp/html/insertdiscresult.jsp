...
<div class="section1">
				...
				<ul class="nav nav-pills nav-stacked">
				    <li class="secleft1"><a href="disc.html">DISC란?</a></li>
					<li class="secleft1"><a href="personal.html">검사하기</a></li>
					<li class="secleft1"><a href="peresult.html">결과보기</a></li>
				</ul>
				<br>
				</div>
</div>
